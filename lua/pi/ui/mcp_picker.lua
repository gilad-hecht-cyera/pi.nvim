...
local function format_mcp_item(mcp_item, width)
  ...
  if is_connected then
    icon_highlight = 'PiContextSwitchOn'
    name_highlight = 'PiContextSwitchOn'
  elseif is_failed then
    icon_highlight = 'PiContextError'
    name_highlight = 'PiContextError'
  else
    icon_highlight = 'PiHint'
    name_highlight = 'PiHint'
  end
