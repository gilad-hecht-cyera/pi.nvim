...
function M.setup()
  local files_source = require('pi.ui.completion.files')
  local subagents_source = require('pi.ui.completion.subagents')
  local commands_source = require('pi.ui.completion.commands')
  local context_source = require('pi.ui.completion.context')
  local skills_source = require('pi.ui.completion.skills')
