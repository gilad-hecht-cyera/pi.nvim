...
---@field message PiMessage Direct reference to message in state.messages
...
---@class RenderedPart
---@field part PiMessagePart Direct reference to part in state.messages
...
function RenderState:reset()
  ...
  self._snapshot_id_index = {} -- snapshot_id -> PiMessagePart
end
