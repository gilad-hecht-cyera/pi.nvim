...
local function add_diff_line(output, line, line_numbers, width, source_path)
  local first_char = line:sub(1, 1)
  local line_hl = first_char == '+' and 'PiDiffAdd' or first_char == '-' and 'PiDiffDelete' or nil
  local gutter_hl = first_char == '+' and 'PiDiffAddGutter'
    or first_char == '-' and 'PiDiffDeleteGutter'
    or 'PiDiffGutter'
...
---@param messages {info: MessageInfo, parts: PiMessagePart[]}[] All messages in the session
