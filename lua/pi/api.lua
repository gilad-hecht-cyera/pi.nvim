...
local window = require('pi.commands.handlers.window').actions
local session = require('pi.commands.handlers.session').actions
local diff = require('pi.commands.handlers.diff').actions
local surface = require('pi.commands.handlers.surface').actions
local workflow = require('pi.commands.handlers.workflow').actions
local permission = require('pi.commands.handlers.permission').actions
local agent = require('pi.commands.handlers.agent').actions
