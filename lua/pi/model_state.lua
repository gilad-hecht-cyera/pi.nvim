...
local function get_model_state_path()
  ...
  return home .. '/.local/state/pi/model.json'
end

---Load model state (favorites, recent, and variants) in Pi CLI format
---@return table
function M.load()
...
---Save model state (favorites, recent, and variants) in Pi CLI format
---@param state table
