local base_context = require('pi.context.base_context')
...
---@param left PiContextSelection|nil
---@param right PiContextSelection|nil
---@return boolean
...
---@param selection PiContextSelection
---@return PiMessagePart
...
---@param diagnostics PiDiagnostic[]
...
---@param selections? PiContextSelection[]
...
---@param buf integer
---@param context_config? PiContextConfig
---@param range? { start_line: integer, end_line: integer }
---@return PiDiagnostic[]|nil
...
---@param opts? { range?: { start: integer, stop: integer }, context_config?: PiContextConfig }
