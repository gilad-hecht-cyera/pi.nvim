...
function M.get_current_buf()
  ...
  if util.is_buf_a_file(curr_buf) then
    ...
    return curr_buf, state.last_code_win_before_pi or win or vim.api.nvim_get_current_win()
  end
end
...
function M.get_diagnostics(buf, context_config, range)
  ...
  local pi_diagnostics = {}
  for _, diag in ipairs(diagnostics) do
    table.insert(pi_diagnostics, {
