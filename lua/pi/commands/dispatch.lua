...
---@type table<PiCommandLifecycleStage, { id: string, fn: PiCommandDispatchHook, command_filter: table<string, true>|nil }[]>
local hook_registry = {
  before = {},
  after = {},
  error = {},
...
---@alias PiCommandHookEntry { id: string, fn: PiCommandDispatchHook, command_filter: table<string, true>|nil }
...
---@param entry { id: string, fn: PiCommandDispatchHook, command_filter: table<string, true>|nil }
---@param ctx PiCommandDispatchContext
---@return boolean
...
---@param stage PiCommandLifecycleStage
---@param hook_id string
---@param hook_fn PiCommandDispatchHook
---@param ctx PiCommandDispatchContext
---@return PiCommandDispatchContext
...
---@param ctx PiCommandActionContext
---@return PiCommandDispatchResult
function M.execute(ctx)
  ---@type PiCommandDispatchContext
  local dispatch_ctx = {
    parsed = ctx.parsed,
