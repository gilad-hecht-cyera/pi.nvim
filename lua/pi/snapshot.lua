-- This file is a port of the snapshot management logic from the original Pi
---@see https://github.com/sst/pi/blob/dev/packages/pi/src/snapshot/index.ts
