...
2. Use Pi normally to generate the events you want to capture
3. Call `:lua require('pi.ui.debug_helper').save_captured_events('data.json')`
...
- Inspect `state.messages` with `:lua vim.print(require('pi.state').messages)`
